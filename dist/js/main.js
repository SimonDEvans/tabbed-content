...
var tabbedContent = function () {
    function tabbedContent() {
        classCallCheck(this, tabbedContent);

        // Set element vars 
        this.$content = jquery('.content');
        this.$sidebarItem = jquery('.sidebar__item');
        this.$contentItem = jquery('.content__item');
    ...
    */
    ...
    createClass(tabbedContent, [{
        key: 'processInteraction',
        value: function processInteraction(e) {
            var item = jquery(e.target);
            var itemId = item.data('button');
            var matchedContent = jquery('[data-content="' + itemId + '"]');
        ...
        */
        ...
        key: 'processWindowEvent',
        value: function processWindowEvent() {
            var item = jquery('.sidebar__item--active');
            var itemId = item.data('button');
            var matchedContent = jquery('[data-content="' + itemId + '"]');
        ...
        */
        ...
        key: 'positionContent',
        value: function positionContent(item, matchedContent) {
        ...
        */
        ...
        value: function bindEvents() {
            ...
            jquery(window).on('load resize', function () {
                return _this.processWindowEvent();
            });
            this.$sidebarItem.on('click', function (e) {
                return _this.processInteraction(e);
            });
        }
    }]);
